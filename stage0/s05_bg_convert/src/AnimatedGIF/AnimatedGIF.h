...
// CYD MP3 player: vendored copy. The decoder only runs in the background
// converter, before Bluetooth starts, when RAM is plentiful -- so it can take
// the wide GIFs people actually have (a phone GIF is often 480-1080 px) and
// shrink them, instead of refusing anything over 480. Costs 1.5 KB of line
// buffer in an object that is freed before Bluetooth starts.
